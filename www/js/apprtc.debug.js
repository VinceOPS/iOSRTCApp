(function(f) {
  ...
  return function e(t, n, r) {
    ...
    SDPUtils.getDtlsParameters = function(mediaSection, sessionpart) {
      ...
      var dtlsParameters = {role:"auto", fingerprints:[{algorithm:fpLine.split(" ")[0].toLowerCase(), value:fpLine.split(" ")[1]}]};
    ...
    var chromeShim = {shimMediaStream:function() {
      ...
      if (typeof window === "object" && window.RTCPeerConnection && !("getSenders" in RTCPeerConnection.prototype) && "createDTMFSender" in RTCPeerConnection.prototype) {
      ...
      RTCPeerConnection.prototype.getStats = function(selector, successCallback, errorCallback) {
        var self = this;
        var args = arguments;
    ...
    module.exports = {shimGetUserMedia:require("./getusermedia"), shimPeerConnection:function() {
      ...
      RTCPeerConnection.prototype.setRemoteDescription = function(description) {
        ...
        sections.forEach(function(mediaSection, sdpMLineIndex) {
          ...
          if (description.type === "offer" && !rejected) {
            var transports = usingBundle && sdpMLineIndex > 0 ? {iceGatherer:self.transceivers[0].iceGatherer, iceTransport:self.transceivers[0].iceTransport, dtlsTransport:self.transceivers[0].dtlsTransport} : self._createIceAndDtlsTransports(mid, sdpMLineIndex);
            ...
            if (self.localStreams.length > 0 && self.localStreams[0].getTracks().length >= sdpMLineIndex) {
              ...
              if (localTrack) {
                if (edgeVersion >= 15019 && kind === "video") {
                  sendEncodingParameters[0].rtx = {ssrc:(2 * sdpMLineIndex + 2) * 1001 + 1};
                }
      ...
      RTCPeerConnection.prototype.createOffer = function() {
        ...
        this.localStreams.forEach(function(localStream) {
          localStream.getTracks().forEach(function(track) {
            tracks.push({kind:track.kind, track:track, stream:localStream, wantReceive:track.kind === "audio" ? numAudioTracks > 0 : numVideoTracks > 0});
            if (track.kind === "audio") {
              numAudioTracks--;
            } else {
              if (track.kind === "video") {
        ...
        tracks.forEach(function(mline, sdpMLineIndex) {
          ...
          sdp += SDPUtils.writeMediaSection(transceiver, transceiver.localCapabilities, "offer", mline.stream);
          sdp += "a=rtcp-rsize\r\n";
        });
    ...
    var safariShim = {shimOnAddStream:function() {
      if (typeof window === "object" && window.RTCPeerConnection && !("onaddstream" in window.RTCPeerConnection.prototype)) {
